...
function getRedirectTo(req: Request) {
  ...
  if (!base) {
    console.warn('WARNING: GR_SITE_URL not set and origin header missing; invite email may lack working link')
    return undefined
  }
  console.log('Redirect URL configured:', base + '/auth/callback')
